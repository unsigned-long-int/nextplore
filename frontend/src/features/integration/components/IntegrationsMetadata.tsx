...
export const IntegrationsMetadata = () => {
    ...
    if (!data || data.length === 0) return <Typography sx={{ color: P.dim, fontSize: '0.82rem' }}>No integrations data available.</Typography>;
        ...
        <Box sx={{
            ...
            <Box sx={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0 }}>
                ...
                <Box sx={{ flex: 1, p: 2.5, minHeight: 0 }}>
                    <VectorsMetadata integration_id={data[active].id} />
                </Box>
            </Box>
        </Box>
    );

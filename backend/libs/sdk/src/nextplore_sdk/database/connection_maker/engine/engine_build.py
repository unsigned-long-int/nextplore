...
from nextplore_sdk.database.connection_maker.registry.auth_strategy_registry import (
    STRATEGY_REGISTRY,
)
...
async def build_engine(profile: ConnectionProfile) -> Engine:
    ...
    return await asyncio.to_thread(
        invoke_engine, adapter_cls.DIALECT, creator=creator, **strategy.pool_settings()
    )

...
from nextplore_sdk.database.connection_maker.auth.azure_asql_strategy import AzureIamAsqlStrategy
from nextplore_sdk.database.connection_maker.auth.credential_auth_strategy import CredentialAuthStrategy
from nextplore_sdk.database.connection_maker.auth.iam_request_signing_auth_strategy import IamRequestSigningAuthStrategy
from nextplore_sdk.database.connection_maker.auth.snowflake_auth_strategy import SnowflakeAuthStrategy
from nextplore_sdk.database.connection_maker.auth.snowflake_jwt_auth_strategy import SnowflakeJwtAuthStrategy
from nextplore_sdk.database.connection_maker.credentials_providers.credentials_provider import CredentialsProvider
from nextplore_sdk.database.connection_maker.credentials_providers.aws_role_credentials_provider import AWSRoleCredentialsProvider
from nextplore_sdk.database.connection_maker.credentials_providers.azure_cert_credentials_provider import AzureCertCredentialsProvider
from nextplore_sdk.database.connection_maker.credentials_providers.azure_secret_credentials_provider import AzureSecretCredentialsProvider
from nextplore_sdk.database.connection_maker.credentials_providers.native_password_credentials_provider import NativePasswordCredentialsProvider
from nextplore_sdk.database.connection_maker.credentials_providers.snowflake_secret_credentials_provider import SnowflakeSecretCredentialsProvider
from nextplore_sdk.database.connection_maker.credentials_providers.snowflake_private_key_credentials_provider import SnowflakePrivateKeyCredentialsProvider
from nextplore_sdk.database.connection_maker.driver_adapters.mysql.pymysql_adapter import MysqlPyMysqlAdapter
from nextplore_sdk.database.connection_maker.driver_adapters.postgresql.psycopg2_adapter import PostgresqlPsycopg2Adapter
from nextplore_sdk.database.connection_maker.driver_adapters.sqlserver.pyodbc_adapter import SqlserverPyOdbcAdapter
from nextplore_sdk.database.connection_maker.driver_adapters.sqlserver.gcp_pytds_adapter import GcpSqlserverPyTdsAdapter
from nextplore_sdk.database.connection_maker.driver_adapters.postgresql.gcp_pg8000_adapter import GcpPostgresqlPg8000Adapter
from nextplore_sdk.database.connection_maker.driver_adapters.mysql.gcp_pymysql_adapter import GcpMysqlPyMysqlAdapter
from nextplore_sdk.database.connection_maker.driver_adapters.postgresql.gcp_pg8000_iam_adapter import GcpPostgresqlPg8000IamAdapter
from nextplore_sdk.database.connection_maker.driver_adapters.mysql.gcp_pymysql_iam_adapter import GcpMysqlPyMysqlIamAdapter
from nextplore_sdk.database.connection_maker.driver_adapters.snowflake.snowflake_adapter import SnowflakeAdapter
from nextplore_sdk.database.connection_maker.driver_adapters.snowflake.snowflake_jwt_adapter import SnowflakeJwtAdapter
...
STRATEGY_REGISTRY: Dict[Tuple[Cloud, DB, Auth], Tuple[Type[AuthStrategy], Type[DriverAdapter], Optional[Type[CredentialsProvider]]]] = {
    ...
    (Cloud.GCP, DB.POSTGRESQL, Auth.IAM): (IamRequestSigningAuthStrategy, GcpPostgresqlPg8000IamAdapter, None),
    (Cloud.GCP, DB.MYSQL, Auth.IAM): (IamRequestSigningAuthStrategy, GcpMysqlPyMysqlIamAdapter, None),

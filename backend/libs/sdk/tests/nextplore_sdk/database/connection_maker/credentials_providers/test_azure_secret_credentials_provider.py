...
class TestAzureSecretCredentialsProvider(unittest.TestCase):
    ...
    @patch('nextplore_sdk.database.connection_maker.credentials_providers.azure_secret_credentials_provider.ClientSecretCredential')
    def test_sets_default_scope_if_not_provided(
        self,
    ...
    @patch('nextplore_sdk.database.connection_maker.credentials_providers.azure_secret_credentials_provider.ClientSecretCredential')
    def test_sets_default_scope_if_provided(
        self,
        client_secret_credential_mock
    ):
        cred_mock = MagicMock()

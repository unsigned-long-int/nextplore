...
class TestFetchSessionMaker(unittest.TestCase):
    def setUp(self):
        self.patcher_sessionmaker = patch('nextplore_sdk.database.connection_maker.session.session_maker.sessionmaker')
        self.patcher_scoped_session = patch('nextplore_sdk.database.connection_maker.session.session_maker.scoped_session')
...
class TestSessionScope(unittest.TestCase):
    ...
    def test_session_scope_error_rolls_back_removes_and_reraises(self):
        ...
        with self.assertRaises(Boom):
            with session_scope(scoped_factory):
                raise Boom('kaboom')

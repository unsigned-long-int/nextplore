...
from nextplore_sdk.database.connection_maker.driver_adapters.mysql.gcp_pymysql_adapter \
    import GcpMysqlPyMysqlAdapter, IPTypes


class TestGcpMysqlPyMysqlAdapter(unittest.TestCase):
    def setUp(self):
        self.adapter = GcpMysqlPyMysqlAdapter()
        self.creds_path = '/Users/nik/Downloads/nextplore-470323-18ec66288496.json'
        self.instance = 'project:region:instance'

    @patch('nextplore_sdk.database.connection_maker.driver_adapters.mysql.gcp_pymysql_adapter.GcpCloudSqlConnector')

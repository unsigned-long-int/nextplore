...
from nextplore_sdk.database.connection_maker.driver_adapters.mysql.gcp_pymysql_iam_adapter \
    import GcpMysqlPyMysqlIamAdapter, IPTypes
...
class TestGcpMysqlPyMysqlIamAdapter(unittest.TestCase):
    ...
    @patch('nextplore_sdk.database.connection_maker.driver_adapters.mysql.gcp_pymysql_iam_adapter.GcpCloudSqlConnector')

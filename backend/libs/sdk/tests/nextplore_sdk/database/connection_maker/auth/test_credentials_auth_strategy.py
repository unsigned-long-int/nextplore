...
class TestAzureIamAsqlStrategy(unittest.TestCase):
    ...
    @patch(
        "nextplore_sdk.database.connection_maker.auth.credential_auth_strategy.resolve_ca_bundle"
    )
    def test_makes_creator_with_creds_provider(self, resolve_ca_bundle_mock):

...
class TestGetCryptoClient(unittest.TestCase):
    ...
    @patch('nextplore_sdk.encryptor.client.azure_crypto_client.CryptographyClient')
    @patch('nextplore_sdk.encryptor.client.azure_crypto_client.DefaultAzureCredential')
    def test_factory_passes_kek_kid_to_client(self, mock_credential, mock_crypto_client):
        kek_kid = 'https://test-vault.vault.azure.net/keys/test-key/version'
    ...
    @patch('nextplore_sdk.encryptor.client.azure_crypto_client.CryptographyClient')
    @patch('nextplore_sdk.encryptor.client.azure_crypto_client.DefaultAzureCredential')
    def test_different_kek_kids_create_different_instances(self, mock_credential, mock_crypto_client):
    ...
    @patch('nextplore_sdk.encryptor.client.azure_crypto_client.CryptographyClient')
    @patch('nextplore_sdk.encryptor.client.azure_crypto_client.DefaultAzureCredential')
    def test_factory_can_be_called_multiple_times(self, mock_credential, mock_crypto_client):
        kek_kid = 'https://test-vault.vault.azure.net/keys/test-key/version'
        factory = get_crypto_client('azure')
    ...
    @patch('nextplore_sdk.encryptor.client.azure_crypto_client.CryptographyClient')
    @patch('nextplore_sdk.encryptor.client.azure_crypto_client.DefaultAzureCredential')
    def test_client_implements_crypto_client_interface(self, mock_credential, mock_crypto_client):
        kek_kid = 'https://test-vault.vault.azure.net/keys/test-key/version'
...
class TestGetCryptoClientIntegration(unittest.TestCase):
    ...
    def test_lambda_captures_correct_client_class(self):
        ...
        try:
            ...
            with patch('nextplore_sdk.encryptor.client.azure_crypto_client.CryptographyClient'):
                with patch('nextplore_sdk.encryptor.client.azure_crypto_client.DefaultAzureCredential'):

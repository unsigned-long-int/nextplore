...
class QueryExecutor:
    ...
    async def execute(self, orm_context: ORMContextResponse, user_identity: UserIdentity) -> AIQueryResponse:
        connection_profile = await self._get_connection_profile(orm_context, user_identity)

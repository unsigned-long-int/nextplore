...
router = APIRouter(prefix="/v1/nextplore-orchestrator", tags=["DescriptionEnhancement"])
...
async def get_description_enhancement(
    ...
    try:
        ...
        logger.error(
            "AI description enhancement failed (remote)",
        ...
        logger.error(
            "AI description enhancement failed (unexpected)",

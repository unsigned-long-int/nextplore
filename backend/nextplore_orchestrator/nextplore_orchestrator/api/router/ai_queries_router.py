    ...
    try:
        ...
        if not request.bypass_cache:
            ...
            if sem_cache_lookup_result:
                response = AIQueryResponse.model_validate(
                    sem_cache_lookup_result.json_payload
                )

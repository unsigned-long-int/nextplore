...
from integration_service.api.dependencies.get_service import get_data_store_service, get_llm_service
...
class TestGetDataStoreService(unittest.TestCase):
    ...
    def test_crypto_client_factory_is_callable_with_kek_kid(self):
        ...
        result = get_data_store_service(**make_data_store_deps(crypto_client_factory=factory))

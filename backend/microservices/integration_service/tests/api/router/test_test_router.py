...
class TestTestRouter(unittest.TestCase):
    ...
    def test_tests_postgres_integration_successfully(
        self,
    ...
    @patch('integration_service.api.router.test_router.to_domain_cloud')
    @patch('integration_service.api.router.test_router.ConnectionProfile')
    def test_tests_snowflake_integration_with_certificate(
        self,
        connection_profile_mock,
        to_domain_cloud_mock,
        to_domain_auth_mock,
    ...
    @patch('integration_service.api.router.test_router.to_domain_cloud')
    @patch('integration_service.api.router.test_router.ConnectionProfile')
    def test_tests_aws_integration_with_role(
        self,
        connection_profile_mock,
        to_domain_cloud_mock,
        to_domain_auth_mock,

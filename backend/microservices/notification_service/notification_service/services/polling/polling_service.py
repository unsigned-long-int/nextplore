...
class EmailOutboxPoller:
    def __init__(self, db_connector: DatabaseBackendConnector, notification_service: NotificationService) -> None:
    ...
    async def start(self) -> None:
        ...
        while self._running:
            try:
                ...
                logger.error(f'Unexpected error in email poller cycle - continuing: {str(e)}', exc_info=True)

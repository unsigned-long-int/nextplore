...
class TestNovitaInference(unittest.IsolatedAsyncioTestCase):
    ...
    @patch('ai_orm_context_service.services.orm_context.model_providers.hugging_face.inference.inference_providers.novita.AsyncOpenAI')

...
from ai_orm_context_service.services.orm_context.model_providers.hugging_face.inference import \
    dispatch_inference_provider


class TestFactory(unittest.TestCase):

    @patch('ai_orm_context_service.services.orm_context.model_providers.hugging_face.inference.inference_provider_factory.factory.INFERENCE_REGISTRY', new_callable=dict)

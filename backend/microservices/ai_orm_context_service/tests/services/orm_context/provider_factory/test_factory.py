...
from ai_orm_context_service.services.orm_context.provider_factory.factory import (
    ProviderFactoryBase,
    HFProviderFactory,
...
class TestHFProviderFactory(unittest.TestCase):
    @patch('ai_orm_context_service.services.orm_context.provider_factory.factory.HFModel')
    @patch('ai_orm_context_service.services.orm_context.provider_factory.factory.dispatch_inference_provider')
    @patch('ai_orm_context_service.services.orm_context.provider_factory.factory.HFProvider')
...
class TestOpenAIProviderFactory(unittest.TestCase):
    @patch('ai_orm_context_service.services.orm_context.provider_factory.factory.OpenAIProvider')
